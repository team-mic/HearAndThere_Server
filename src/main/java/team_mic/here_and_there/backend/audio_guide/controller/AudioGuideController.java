...
public class AudioGuideController {
    ...
    public ResponseEntity<ResAudioGuideListDto> getAudioGuideList(@ApiParam(value = "오디오 가이드의 카테고리 : random / traditional / shopping 중 하나", required = true, example = "random")
    ...
    public ResponseEntity<Void> addDumpData(){
        ...
        imageSet.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/gangnam.png");
        ...
        AudioTrack audioTrack = AudioTrack.builder()
                .audioFileUrl("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/audio-files/Whenever+Wherever.mp3")
                .build();
        ...
        imageSet2.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/gwanghwa.png");
        ...
        imageSet3.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/insadong.png");
        ...
        imageSet4.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/jongno.png");
        ...
        imageSet5.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/bukchon.png");
        ...
        imageSet6.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/dongdaemun.png");
        ...
        imageSet7.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/jamsil.png");
        ...
        imageSet8.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/namdaemun.png");
