...
public class AudioGuideDataService {
  ...
  @Transactional
  public void addSubCategoryToGuides() {
      /*List<AudioGuideLanguageContent> guideLanguageContents = audioGuideLanguageContentRepository.findAll();

      guideLanguageContents.stream()
        .forEach(guideLanguageContent->{
            if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.HISTORY.getDatabaseKoreanName())){
              if(guideLanguageContent.getAudioGuide().getId()==14L || guideLanguageContent.getAudioGuide().getId()==15L || guideLanguageContent.getAudioGuide().getId()==16L){
                guideLanguageContent.updateSubCategory(AudioGuideSubCategory.SEOUL_PALACE.getKorName());
              }else if(guideLanguageContent.getAudioGuide().getId()==7L || guideLanguageContent.getAudioGuide().getId()==5L || guideLanguageContent.getAudioGuide().getId()==11L){
                guideLanguageContent.updateSubCategory(AudioGuideSubCategory.MODERN_HISTORY_COEXIST.getKorName());
              }
            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.HISTORY.getDatabaseEnglishName())){
              if(guideLanguageContent.getAudioGuide().getId()==14L || guideLanguageContent.getAudioGuide().getId()==15L || guideLanguageContent.getAudioGuide().getId()==16L){
                guideLanguageContent.updateSubCategory(AudioGuideSubCategory.SEOUL_PALACE.getEngName());
              }else if(guideLanguageContent.getAudioGuide().getId()==7L || guideLanguageContent.getAudioGuide().getId()==5L || guideLanguageContent.getAudioGuide().getId()==11L){
                guideLanguageContent.updateSubCategory(AudioGuideSubCategory.MODERN_HISTORY_COEXIST.getEngName());
              }

            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.MUSIC.getDatabaseKoreanName())){
                guideLanguageContent.updateSubCategory(AudioGuideSubCategory.K_POP_LAN.getKorName());
            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.MUSIC.getDatabaseEnglishName())){
                guideLanguageContent.updateSubCategory(AudioGuideSubCategory.K_POP_LAN.getEngName());

            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.SHOPPING.getDatabaseKoreanName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.SEOUL_SHOPPING.getKorName());
            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.SHOPPING.getDatabaseEnglishName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.SEOUL_SHOPPING.getEngName());
            }

            else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.ART.getDatabaseKoreanName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.BECOME_ARTIST.getKorName());
            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.ART.getDatabaseEnglishName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.BECOME_ARTIST.getEngName());
            }

            else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.NATURE.getDatabaseKoreanName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.NATURE_IN_CITY.getKorName());
            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.NATURE.getDatabaseEnglishName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.NATURE_IN_CITY.getEngName());
            }

            else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.EXCURSION.getDatabaseKoreanName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.ENJOY_DAY.getKorName());
            }else if(guideLanguageContent.getMainCategory().equals(AudioGuideMainCategory.EXCURSION.getDatabaseEnglishName())){
              guideLanguageContent.updateSubCategory(AudioGuideSubCategory.ENJOY_DAY.getEngName());
            }
        });*/
  }
}
