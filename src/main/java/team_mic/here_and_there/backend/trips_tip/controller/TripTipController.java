...
public class TripTipController {
    ...
    public ResponseEntity<Void> addDumpData(){
        ...
        images.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/bicycle_tip.png");
        TripTip tripTip=TripTip.builder()
                .images(images)
                .title("Rent a bicycle in seoul for 1$")
                .description("If you want to rent a bike instead of public transportation or walking, try the Seoul bike!\n" +
                        "If you want to rent a bike instead of public transportation or walking, try the Seoul bike!\n" +
                        "If you want to rent a bike instead of public transportation or walking, try the Seoul bike!")
                .build();

        Set<String> images2=new HashSet<>();
        images2.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/before_a_trip.png");
        TripTip tripTip2 =TripTip.builder()
                .images(images2)
                .title("Things to know before a trip")
                .description("How's the weather in Korea? How can i use public transportation? Here's information about korea\n" +
        ...
        images3.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/bicycle_tip.png");
        ...
        images4.add("https://here-and-there.s3.ap-northeast-2.amazonaws.com/audio-guides/images/before_a_trip.png");
